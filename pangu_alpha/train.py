...
from src.transformer import TransformerOpParallelConfig, TransformerRecomputeConfig
from mindspore.train.callback import ModelCheckpoint, CheckpointConfig
from mindspore.train.serialization import load_distributed_checkpoint, load_checkpoint, load_param_into_net

from src.pangu_alpha_new import PanGUAlphaWithLoss, PanguAlphaModel
from src.transformer import TransformerOpParallelConfig, TransformerRecomputeConfig
...
def run_train(args_opt):
    ...
    context.set_context(save_graphs=True, save_graphs_path="./graphs_of_device_id_" + str(rank))
